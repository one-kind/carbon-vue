<template>
  <div :class="`${carbonPrefix}--pagination`" data-pagination>
    <div :class="`${carbonPrefix}--pagination__left`">
      ...
      >
        <SelectOption
          ...
          >{{ size.label ? size.label : size.value ? size.value : size }}</SelectOption
        >
      </Select>
    ...
    <div :class="`${carbonPrefix}--pagination__right`">
      ...
      <button
        ...
        :disabled="noWayBack"
      >
        <Icon icon="CaretLeft" :class="`${carbonPrefix}--pagination__button-icon`" />
      </button>
      ...
      >
        <Icon icon="CaretRight" :class="`${carbonPrefix}--pagination__button-icon`" />
      </button>
    </div>
  </div>
</template>
