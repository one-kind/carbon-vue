<template>
  <div :class="`${carbonPrefix}--form-item`">
    ...
    <div :class="`${carbonPrefix}--text-input__field-wrapper`" :data-invalid="isInvalid">
      <Icon icon="WarningFilled" v-if="isInvalid" :class="`${carbonPrefix}--text-input__invalid-icon`" />
      <input
        :id="uid"
        :class="[
      ...
      >
        ...
        <Icon icon="ViewOff" v-if="isPasswordVisible" :class="`${carbonPrefix}--icon-visibility-off`" />
        <Icon icon="View" v-else :class="`${carbonPrefix}--icon-visibility-off`" />
      </button>
    </div>
    <div
      v-if="isHelper"
