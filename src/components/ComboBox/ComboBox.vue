<template>
  <div :class="classes" @focusout="onFocusOut">
    <label
      v-if="title"
      :for="uid"
    ...
    <div
      ...
      :class="[
        ...
        {
          // TODO [`${carbonPrefix}--list-box--light`]: theme === 'light',
...
export default {
  name,
  inheritAttrs: false,
  mixins: [Theme, Uid, CarbonPrefix, Methods({ input: ['focus', 'blur'] })],
  props: {
    autoFilter: Boolean,
  ...
  computed: {
    classes () {
      ...
      return {
        [`${carbonPrefix}--list-box__wrapper`]: true,
